...
CREATE TABLE IF NOT EXISTS `mydb`.`funcionario` (
  ...
  INDEX `fk_funcionario_cidade1_idx` (`idcidade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`animal_paciente` (
  ...
  INDEX `fk_animal_raça1_idx` (`idespecie` ASC) VISIBLE,
  INDEX `fk_animal_paciente_cliente_dono1_idx` (`idcliente_dono` ASC) VISIBLE,
  CONSTRAINT `fk_animal_raça1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`atendimento` (
  ...
  INDEX `fk_consulta_animal_paciente1_idx` (`idpaciente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`procedimento` (
  ...
  INDEX `fk_procedimento_atendimento1_idx` (`idatendimento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`vacina` (
  ...
  INDEX `fk_vacina_procedimento1_idx` (`procedimento_idprocedimento` ASC) VISIBLE,
